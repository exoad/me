...
export default function ProjectsPage({ scaffoldProps = {} }) {
    ...
    return <Scaffold {...scaffoldProps}>
        <ScaffoldContent className="px-6 mt-32 gap-32" useDefaultLayout>
            <div className="relative">
                <h2 className="absolute -top-10 left-0 text-5xl md:text-7xl font-extrabold text-white/15 uppercase tracking-widest">
                    Projects
                </h2>
                <h3 className="relative text-4xl font-bold text-white">What I've Built</h3>
                <p className="text-white/70 mt-2 max-w-md text-lg">
                    Built with my passion to have fun learning novel concepts.
                </p>
            </div>
            <div className="grid md:gap-15 gap-12 sm:grid-cols-2 lg:grid-cols-3">
                                ...
                                {proj.demoImage ? (
                                    ...
                                    <>
                                        <img
                                            ...
                                            className="absolute inset-0 w-full h-full object-cover blur-2xl scale-85 opacity-40"
                                        />
                                        <img
                                            src={proj.logo}
                                            alt={`${proj.title} logo`}
                                    ...
                                    <div
                                        className={`absolute inset-0 rounded-full p-4 w-full h-full scale-65 blur-3xl opacity-20 bg-gradient-to-br ${gradients[index % gradients.length]}`}
                                    />
                                )}
                            </div>
                            <div className="p-5">
