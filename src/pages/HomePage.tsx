...
function NameCard() {
	// Gruvbox colors for each letter
	const colors = ['text-red', 'text-green', 'text-yellow', 'text-blue', 'text-purple', 'text-aqua', 'text-orange', 'text-gray', 'text-red', 'text-green', 'text-yellow'];
