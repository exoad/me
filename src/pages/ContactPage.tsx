            ...
            <ScaffoldContent useDefaultLayout>
                <div className="flex flex-col md:flex-row items-center md:gap-16 gap-8 w-full max-w-4xl">
                    <div className="flex flex-col items-center md:items-start text-center md:text-left gap-8 w-full">
                        <h1 className="text-gb-fg0 text-4xl md:text-6xl font-bold font-playfair mb-2 transition-all duration-700">
                            {strings.pages.contact.title}
                        </h1>
                        <p className="text-gb-fg3 text-base md:text-lg font-montserrat leading-relaxed mb-4 transition-all duration-700 md:px-0 px-8">
...
function ResumeBlock() {
    return <div className="w-full max-w-md mt-4 mb-2 flex flex-col items-center md:items-start">
        <a
            ...
            className="relative flex items-center justify-center px-6 py-3 rounded-md text-gb-fg0 font-montserrat font-semibold transition-all duration-700 group"
        >
        ...
        <span className="text-xs text-gb-fg4 font-montserrat mt-2">
